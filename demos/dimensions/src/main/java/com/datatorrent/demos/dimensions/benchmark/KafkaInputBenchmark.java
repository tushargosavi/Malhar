...
import com.datatorrent.demos.dimensions.benchmark.BenchmarkPartitionableKafkaInputOperator;
 ...
 * You can set the property file to make it using either {@link com.datatorrent.contrib.kafka.SimpleKafkaConsumer} or {@link com.datatorrent.contrib.kafka.HighlevelKafkaConsumer}
...
public class KafkaInputBenchmark implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    dag.setAttribute(DAG.APPLICATION_NAME, "KafkaInputBenchmark");
