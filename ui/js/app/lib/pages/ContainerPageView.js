...
var ContainerPageView = BasePageView.extend({
    ...
    initialize: function(options){
        ...
        this.defineWidgets([
            ...
            { name: 'networkGauge', defaultId: 'network gauge', view: GaugeWidget, limit: 0, inject: {
                label: 'Network'
            }},
    ...
    defaultDashes: [
        {
            ...
            widgets: [
                ...
                { widget: 'memoryGauge', id: 'memory gauge', width: 33 },
                { widget: 'cpuGauge', id: 'CPU gauge', width: 33 },
                { widget: 'networkGauge', id: 'network gauge', width: 34 },
