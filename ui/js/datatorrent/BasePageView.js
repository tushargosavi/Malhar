...
var BasePageView = BaseView.extend({
    ...
    // Default page render method. Optionally takes a widgets argument
    // for use with this.loadDash
    render: function(widgets) {
        ...
        // get selected dash
        var curDash = this.__wDashes.where({'selected': true})[0];
        
        // get selected dash's widgets
        widgets = widgets || curDash.get('widgets');
